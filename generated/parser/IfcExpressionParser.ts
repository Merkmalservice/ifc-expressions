...
export default class IfcExpressionParser extends Parser {
	...
	public get literalNames(): (string | null)[] { return IfcExpressionParser.literalNames; }
	public get symbolicNames(): (string | null)[] { return IfcExpressionParser.symbolicNames; }
	public get ruleNames(): string[] { return IfcExpressionParser.ruleNames; }
	public get serializedATN(): number[] { return IfcExpressionParser._serializedATN; }
	...
	public numExpr(_p?: number): NumExprContext {
		...
		let localctx: NumExprContext = new NumExprContext(this, this._ctx, _parentState);
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					case 1:
						...
						if(!(_la===1 || _la===2)) {
						    (localctx as NumMulDivContext)._op = this._errHandler.recoverInline(this);
						}
						else {
					...
					case 2:
						...
						_la = this._input.LA(1);
						if(!(_la===3 || _la===4)) {
						    (localctx as NumAddSubContext)._op = this._errHandler.recoverInline(this);
						}
						else {
							this._errHandler.reportMatch(this);
						    this.consume();
	...
	public objectRef(): ObjectRefContext {
		let localctx: ObjectRefContext = new ObjectRefContext(this, this._ctx, this.state);
	...
	public attributeRef(): AttributeRefContext {
		let localctx: AttributeRefContext = new AttributeRefContext(this, this._ctx, this.state);
	...
	public nestedObjectChain(): NestedObjectChainContext {
		let localctx: NestedObjectChainContext = new NestedObjectChainContext(this, this._ctx, this.state);
		...
		try {
			...
			case 8:
				...
				this.state = 78;
				(localctx as NestedObjectChainEndContext)._name = this.match(IfcExpressionParser.RESERVED_ATTRIBUTE_NAME);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public namedRef(): NamedRefContext {
		let localctx: NamedRefContext = new NamedRefContext(this, this._ctx, this.state);
	...
	public arrayElementList(): ArrayElementListContext {
		let localctx: ArrayElementListContext = new ArrayElementListContext(this, this._ctx, this.state);
	...
	private numExpr_sempred(localctx: NumExprContext, predIndex: number): boolean {
		switch (predIndex) {
		case 0:
	...
	public static readonly _serializedATN: number[] = [4,1,22,110,2,0,7,0,2,
	...
	static DecisionsToDFA = IfcExpressionParser._ATN.decisionToState.map( (ds: DecisionState, index: number) => new DFA(ds, index) );
...
export class ExprContext extends ParserRuleContext {
	...
	public attributeRef(): AttributeRefContext {
		return this.getTypedRuleContext(AttributeRefContext, 0) as AttributeRefContext;
	}
	public functionCall(): FunctionCallContext {
...
export class AttributeRefContext extends ParserRuleContext {
	...
	public nestedObjectChain(): NestedObjectChainContext {
		return this.getTypedRuleContext(NestedObjectChainContext, 0) as NestedObjectChainContext;
	}
    public get ruleIndex(): number {
...
export class ArrayContext extends ParserRuleContext {
	...
	public arrayElementList(): ArrayElementListContext {
		return this.getTypedRuleContext(ArrayElementListContext, 0) as ArrayElementListContext;
	}
    public get ruleIndex(): number {
